...
void extractNumbers(const char* input, int* num1, int* num2, int* num3, int* num4, int* num5, int* num6){if(sscanf(input, "%d:%d:%d:%d:%d:%d", num1, num2, num3, num4, num5, num6) == 6){}else{ *num1 = 1; }}
